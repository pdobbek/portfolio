...
ALLOWED_HOSTS = ['www.patrykdobbek.com', 'patrykdobbek.com', 'portfoliosite-env.eba-qrbt88md.eu-west-2.elasticbeanstalk.com', '127.0.0.1']
...
STATICFILES_DIRS = (
    ...
    BASE_DIR.joinpath('algoviewer/static')
)
